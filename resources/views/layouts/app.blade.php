...
<head>
    ...
    <title>
        @yield('title', config('app.name', 'Company Admin Tool'))
    </title>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        @auth
                            <li class="nav-item">
                                <a class="nav-link text-white {{ request()->routeIs('companies.*') ? 'active fw-bold' : '' }}" href="{{ route('companies.index') }}">
                                    Companies
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-white {{ request()->routeIs('employees.*') ? 'active fw-bold' : '' }}" href="{{ route('employees.index') }}">
                                    Employees
                                </a>
                            </li>
                        @endauth
